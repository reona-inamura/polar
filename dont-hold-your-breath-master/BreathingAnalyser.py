...
class BreathingAnalyser:
    def __init__(self, acc_data, ibi_data, paticipant_id):
        ...
        self.paticipant_id = paticipant_id
    ...
    def save_breathing_rate(self):
        # Save breathing rate data to a CSV file
        np.savetxt("data/"+self.paticipant_id+"_breathing_rate.csv", np.column_stack((self.br_times, self.br_values_smooth)), delimiter=",")
    ...
    def show_breathing_signal(self):
        ...
        plt.savefig("img/"+self.paticipant_id + "_acc_lowpass.png")
        ...
        plt.savefig("img/"+self.paticipant_id + "_acc_filtered.png")
        #plt.show(block=False)
    ...
    def show_heart_rate_variability(self):
        ...
        plt.savefig("img/"+self.paticipant_id + "_breath_peaks.png")
        #plt.show(block=False)
        ...
        ax2.set_xlabel('Time')
        plt.savefig("img/"+self.paticipant_id + "_br_hrv_overtime.png")
        #plt.show(block=False)
        ...
        plt.ylabel('HRV')
        plt.savefig("img/"+self.paticipant_id + "_br_hrv.png")
        #plt.show() 